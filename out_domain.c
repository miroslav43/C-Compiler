...
// domain: global
int x;	// size=4, mem=0x142e074e0
char y;	// size=1, mem=0x142e07550
double z;	// size=8, mem=0x142e075c0
double p[100];	// size=800, mem=0x142e07630
struct S1{
	int i;	// size=4, idx=0
	double d[2];	// size=16, idx=4
	char x;	// size=1, idx=20
	};	// size=21
struct S1 p1;	// size=21, mem=0x142e07a80
struct S1 vp[10];	// size=210, mem=0x142e07c00
